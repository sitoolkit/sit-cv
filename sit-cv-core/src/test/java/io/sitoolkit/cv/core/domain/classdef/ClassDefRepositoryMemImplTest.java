...
public class ClassDefRepositoryMemImplTest {
  ...
  public void resolveMethodCallsAndStatements() {
    ...
    BranchStatement statementResult1 =
        (BranchStatement)
            repository
                .findMethodByQualifiedSignature("a.b.c.Controller.controller1()")
                .getStatements()
                .get(0);
    MethodCallDef methodCallResult1 =
        (MethodCallDef) statementResult1.getConditions().get(0).getChildren().get(0);
    ...
    assertThat(methodCallResult1.getMethodCalls().iterator().next() == methodCallResult2, is(true));
    ...
    assertThat(methodCallResult2.getMethodCalls().iterator().next() == methodCallResult3, is(true));
  }
  ...
  public void resolveInfiniteMethodCalls() {
    ...
    MethodDef methodResult1 =
        repository.findMethodByQualifiedSignature("a.b.c.Controller.controller1()");
    ...
    assertThat(methodCallResult1.getMethodCalls().size(), is(1));
    assertThat(
        methodCallResult1.getMethodCalls().iterator().next().getQualifiedSignature(),
    ...
    assertThat(
        ...
        is("a.b.c.Controller.controller2()"));
  }
