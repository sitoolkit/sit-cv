...
public class StatementVisitor2 extends VoidVisitorAdapter<VisitContext2> {
    ...
    public static StatementVisitor2 build(JavaParserFacade jpf) {
        MethodResolver methodResolver = new MethodResolver(jpf);
        return new StatementVisitor2(methodResolver);
    }

    @Override
    public void visit(ForeachStmt foreachStmt, VisitContext2 context) {
    ...
    @Override
    public void visit(ForStmt forStmt, VisitContext2 context) {
    ...
    @Override
    public void visit(IfStmt ifStmt, VisitContext2 context) {
    ...
    @Override
    public void visit(WhileStmt n, VisitContext2 context) {
        super.visit(n, context);
    }

    @Override
    public void visit(MethodCallExpr methodCallExpr, VisitContext2 context) {
    ...
    @Override
    public void visit(LambdaExpr n, VisitContext2 context) {
        if (context.isInLoop()) {
            super.visit(n, context);
        }
    }
    ...
    @Override
    public void visit(MethodReferenceExpr n, VisitContext2 context) {
        if (context.isInLoop()) {
            super.visit(n, context);
