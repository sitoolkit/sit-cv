...
public class ServiceFactory {
    ...
    public static ServiceFactory initialize() {
        ...
        factory.designDocService = factory.buildDesignDocService(config);
        factory.reportService = factory.buildReportService(factory.designDocService);

        return factory;
    }

    protected DesignDocService buildDesignDocService(Config config) {
        ...
        return new DesignDocService(classDefReader, sequenceProcessor, classProcessor,
                sequenceWriter, classWriter, classFilter, classDefRepository, watcher);
